            ...
            => services.AddLogging(x => x.AddConsole())
                       ...
                       .AddSwaggerGen(
                           x =>
                           {
                               ...
                               x.IncludeXmlComments(Path.Combine(ApplicationEnvironment.ApplicationBasePath, $"{nameof(QuestionnairesAPI)}.xml"), true);
                               ...
                               foreach (ApiVersionDescription description in descriptions)
                               {
                                   x.SwaggerDoc(
                                       ...
                                       new Info
                                       {
                                           ...
                                           License = new License { Name = "MIT", Url = "https://github.com/austindrenski/AD.Questionnaires/blob/master/LICENSE" },
                                           Description = "The Questionnaires API provides extraction services for questionnaires and surveys."
                                       });
                               }
                           })
                       .AddMvc(
